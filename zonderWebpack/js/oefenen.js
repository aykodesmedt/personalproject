...
const $toggleHulp = document.querySelector("#toggleHulp");
const $uitgebeeldeLetter = document.querySelector("#uitgebeeldeLetter");
const canvas = document.querySelector("#canvasOefenen");
const $canvasDiv = document.querySelector("#canvasDiv");
const $leapLetter = document.querySelector(".leapLetter");
// const $rotationInput = document.querySelector("#rotationInput");

// const handleChangeRotation = e => {
//   //   console.log(e.currentTarget.value);
//   //   gltfrotation = e.currentTarget.value;
//   //   renderer.render(scene, camera);
//   //   // loadCanvas(e.currentTarget.value);
// };

// $rotationInput.addEventListener("change", handleChangeRotation);

const handleClickHulp = () => {
  toggle = !toggle;
  if (toggle) {
...
$toggleHulp.addEventListener("click", handleClickHulp);
...
const handleClickLetterButton = e => {
  ...
  $toggleHulp.classList.remove("hidden");
  if (toggle) {
    handleClickHulp();
  }
  ...
  controller.on("frame", function(frame) {
    ...
    if (frame.hands.length > 0) {
      ...
      tf.tidy(() => {
        ...
        console.log(label);
        $uitgebeeldeLetter.innerHTML = label;
        if ($uitgebeeldeLetter.innerHTML === $gekozenLetter) {
          $leapLetter.classList.remove("wrongLetter");
          $leapLetter.classList.add("goodLetter");
        } else {
          $leapLetter.classList.remove("goodLetter");
          $leapLetter.classList.add("wrongLetter");
        }
      });
    }
  });
